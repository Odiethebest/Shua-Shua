# Interview — the engine, explained out loud (study & interview prep)
...
foundations-first: the engine core, then the behavior features built on it. For the
formal, LaTeX math (derivations, numerical analysis, complexity), see
